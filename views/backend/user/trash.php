                        ...
                        <tbody>
                            <?php foreach ($list as $rows) : ?>
                                ...
                                <td class="text-center">
                                    <a href="index.php?option=user&cat=retrash&id=<?php echo $rows['Id']; ?>" title="Khôi phục" class="btn btn-sm btn-primary">
                                    ...
                                    <a href="index.php?option=user&cat=del&id=<?php echo $rows['Id']; ?>" title="Xóa vào" class="btn btn-sm btn-danger">

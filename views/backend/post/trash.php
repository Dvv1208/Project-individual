        ...
        <div class="card">
            <div class="row">
                <div class="col-12 text-right">
                    <a href="index.php?option=post" class="btn btn-sm btn-info"><i class="fas fa-undo"></i> Quay lại
                        danh sách
                    </a>
                </div>
            </div>
                    ...
                    <tbody>
                        <?php foreach ($list as $row) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="index.php?option=post&cat=retrash&id=<?php echo $row['Id']; ?>" title="Khôi phục" class="btn btn-sm btn-primary">
                                    ...
                                    <a href="index.php?option=post&cat=del&id=<?php echo $row['Id']; ?>" title="Xóa vĩnh viễn" class="btn btn-sm btn-danger">

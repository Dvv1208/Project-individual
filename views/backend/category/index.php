            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-12 text-right">
                        <a href="index.php?option=category&cat=create" class="btn btn-sm btn-success"><i
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <?php endif; ?>
                                <a href="index.php?option=category&cat=detail&id=<?php echo $row['Id'];?>"
                                    title="Chi tiết" class="btn btn-sm btn-primary">
                                    <i class="fas fa-eye"></i>
                                </a>

                                <a href="index.php?option=category&cat=edit&id=<?php echo $row['Id'];?>"

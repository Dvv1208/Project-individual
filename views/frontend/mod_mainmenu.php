                ...
                <?php foreach ($list_menu as $row_menu) : ?>
                    ...
                    if (count($list_menu1) != 0) : ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-light" href="<?php echo $row_menu['Link'] ?>" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <?php else : ?>
                        <li class="nav-item">
                            <a class="nav-link text-light" href="<?php echo $row_menu['Link'] ?>"><?php echo $row_menu['Name'] ?></a>
                        </li>
                    <?php endif; ?>
                <?php endforeach; ?>

    ...
    <?php foreach ($listcategory1 as $rowcat1) : ?>
        ...
        <?php if (count($listcategory2) != 0) : ?>
            <li class="list-group-item">
                <ul class="">
                    <a class="nav-link dropdown-toggle text-dark" href="" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" href="index.php?option=product&cat=<?php echo $rowcat1['Slug']; ?>"><?php echo $rowcat1['Name']; ?>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <?php foreach ($listcategory2 as $rowcat2) : ?>
                            <li class="list-group-item">
                                <a class="dropdown-item" href="index.php?option=product&id=<?php echo $rowcat2['Slug']; ?>"><?php echo $rowcat2['Name']; ?></a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </ul>

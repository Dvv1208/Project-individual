        ...
        <div class="row">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb my-3">
                    ...
                    <li class="breadcrumb-item"><a style="text-decoration: none" href="index.php?option=post&cat=id">Bài viết</a></li>
    ...
    <div class="container my-3">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6">
                <img src="public/images/post/<?php echo $row_post['Img']; ?>" class="img-fluid w-100" alt="<?php echo $row_post['Img']; ?>">
            </div>
            <div class="col-md-6 col-lg-6">
                ...
                <p>
                <div class="fb-like" data-href="index.php?option=post&id=<?php echo $slug; ?>" data-width="" data-layout="standard" data-action="like" data-size="small" data-share="true"></div>
                </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="fb-comments" data-href="index.php?option=post&id=<?php echo $slug; ?>" data-width="100%" data-numposts="5"></div>
            </div>
        </div>
        <!--end row-->
        <div class="div my-3">

    ...
    <div class="container my-3">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6">
                <img src="public/images/product/<?php echo $row_pro['Img']; ?>" class="img-fluid w-100" alt="<?php echo $row_pro['Img']; ?>">
            </div>
            <div class="col-md-6 col-lg-6">
                ...
                <div class="input-group input-group-sm mb-3">
                    <input type="number" name="qty" value="1" min="1" style="width:100px" aria-describedby="basic-addon2">

                    <a href="index.php?option=cart&addcart=<?php echo $row_pro['Id']; ?>" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Thêm vào giỏ hàng</a>
